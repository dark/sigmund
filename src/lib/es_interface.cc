...
void ElasticSearchInterface::setup_es_documents() {
  ...
  std::string postdata = "{\"mappings\":{\"summary-report\":{\"properties\":{\"time\":{\"type\":\"date\",\"format\":\"epoch_millis\"},\"hostname\":{\"type\":\"string\",\"index\":\"not_analyzed\"},\"basename\":{\"type\":\"string\",\"index\":\"not_analyzed\"},\"procname\":{\"type\":\"string\",\"index\":\"not_analyzed\"},\"module\":{\"type\":\"string\",\"index\":\"not_analyzed\"}}},\"detailed-report\":{\"properties\":{\"time\":{\"type\":\"date\",\"format\":\"epoch_millis\"},\"hostname\":{\"type\":\"string\",\"index\":\"not_analyzed\"},\"basename\":{\"type\":\"string\",\"index\":\"not_analyzed\"},\"procname\":{\"type\":\"string\",\"index\":\"not_analyzed\"},\"module\":{\"type\":\"string\",\"index\":\"not_analyzed\"}}}}}";
